...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        JMenuItem br1 = new JMenuItem("Branch Syllabus");
        JMenuItem br2 = new JMenuItem("Branch Details");
        JMenuItem br3 = new JMenuItem("Branch Faculties");
        branch.setForeground(Color.RED); 
        

        br1.setFont(new Font("monospaced",Font.BOLD,16));
        ...
        br1.setIcon(new ImageIcon(image19));
        br1.setMnemonic('I');
        br1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C, ActionEvent.CTRL_MASK));
        br1.setBackground(Color.WHITE);
        

        br2.setFont(new Font("monospaced",Font.BOLD,16));
        ...
        br2.setIcon(new ImageIcon(image21));
        br2.setMnemonic('J');
        br2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_X, ActionEvent.CTRL_MASK));
        br2.setBackground(Color.WHITE);
        

        br3.setFont(new Font("monospaced",Font.BOLD,16));
        ...
        br3.setIcon(new ImageIcon(image10));
        br3.setMnemonic('K');
        br3.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_W, ActionEvent.CTRL_MASK));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        else if(msg.equals("Branch Syllabus")) {
        	new BranchSyllabus();
        }
        else if(msg.equals("Branch Faculties")) {
        	new BranchFaculties();
        }
        else if(msg.equals("Branch Details")) {
        	new BranchDetails();
        }
